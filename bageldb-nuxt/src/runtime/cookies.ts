...
function parse(str: string, options?: Record<string, any>): Record<string, any> {
...
function serialize(name: string, val: string, options: Record<string, any>) {
  const opt = options || {};
...
function tryDecode(str: string, decode: (arg0: any) => any) {
  try {
    return decode(str);
  } catch (e) {
    return str;
